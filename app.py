...
# Variable para firmar y verificar JWT (sale del .env vía config.py)
...
def validar_usuario():
    ...
    try:
        ...
        if bcrypt.checkpw(password.encode("utf-8"), hash_guardado):
            ...
            token = jwt.encode(payload, clave_secreta, algorithm=JWT_ALGORITHM)
...
def requiere_token(f):
    ...
    def decorador(*args, **kwargs):
        ...
        try:
            ...
            payload = jwt.decode(token, clave_secreta, algorithms=[JWT_ALGORITHM])
